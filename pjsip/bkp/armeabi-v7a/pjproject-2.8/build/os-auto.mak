...
export OS_CXXFLAGS := $(CC_DEF)PJ_AUTOCONF=1  -shared --sysroot=/home/ubuntu/android-ndk-r13b/platforms/android-24/arch-arm -lgcc -no-canonical-prefixes -march=armv7-a -Wl,--fix-cortex-a8 -Wl,--build-id -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now -Wl,--warn-shared-textrel -Wl,--fatal-warnings -lc -lm -fexceptions -frtti

export OS_LDFLAGS  :=  --sysroot=/home/ubuntu/android-ndk-r13b/platforms/android-24/arch-arm -L/home/ubuntu/android-ndk-r13b//sources/cxx-stl/gnu-libstdc++/4.9/libs/armeabi-v7a/ -L/home/ubuntu/2.8_all/plivo-android-sdk/openssl/armeabi-v7a/lib -lssl -lcrypto -lm -lgnustl_static  -lc -lgcc -ldl -lOpenSLES -llog -lGLESv2 -lEGL -landroid
